...
namespace ENet.Managed
{
    public sealed unsafe class ENetHost : DisposableBase
    {
        ...
        public void UseNewPacket(uint state)
        {
            CheckDispose();
            LibENet.UseNewPacket(m_Pointer, state);
        }
        ...
        public void SetHostIP(NativeENetAddress* addr, string hostName)
        {
            CheckDispose();
            LibENet.AddressSetHost(addr, hostName);
        }
        ...
        public void EnableNewProtocol(int state)
        {
            ...
            //LibENet.usingNewPacketDelegate(0);
        }
