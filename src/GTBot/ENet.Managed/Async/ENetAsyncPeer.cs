...
namespace ENet.Managed.Async
{
    ...
    {
        private static readonly UnboundedChannelOptions s_ReceiveChannelOptions = new UnboundedChannelOptions()
        {
        ...
        private readonly TaskCompletionSource<uint> m_DisconnectCompletionSource = new TaskCompletionSource<uint>(TaskCreationOptions.RunContinuationsAsynchronously);
