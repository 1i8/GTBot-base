...
namespace ENet.Managed.Async
{
    ...
    public sealed class ENetAsyncHost : IDisposable
    {
        ...
        private static readonly UnboundedChannelOptions s_AcceptChannelOptions = new UnboundedChannelOptions()
        {
        ...
        private readonly TaskCompletionSource<bool> m_StopCompletionSource = new TaskCompletionSource<bool>(TaskCreationOptions.RunContinuationsAsynchronously);
